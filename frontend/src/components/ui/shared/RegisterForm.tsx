          ...
          <div className="p-8 lg:p-12 flex flex-col justify-between">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                 BasearpsYield is a contemporary agricultural brand that embodies modern farming techniques and sustainability. Focused on innovative practices and high-quality produce, BasearpsYield offers a refined approach to farming that blends timeless traditions with cutting-edge technology.
              </p>
            </div>
            {/* <div>
