            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
               ...
               <div className="bg-white p-8">
                  ...
                  <p className="text-gray-600 mb-4">
                     At BasearpsYield, we believe in reshaping the future of agriculture through innovative technology. Our platform brings farms and financial markets together, creating an ecosystem where anyone can participate in the agricultural value chain. Farmers get the support they need to grow, investors earn returns from sustainable farming, and communities benefit from responsible agriculture.


                  </p>
                  <p className="text-gray-600 mb-4">
                     Backed by blockchain technology, BasearpsYield ensures every investment is safe, traceable, and impactful. We empower people to make a difference—not just in their portfolios but also in how food is grown.
                  </p>
                  <p className="text-gray-600 mb-4">
          ...
          <p className="text-gray-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 pt-12">
               ...
               <div className="bg-white p-6 rounded-lg shadow-md">
                  ...
                  <p className="text-gray-600">
                     BasearpsYield automates key processes—such as payouts, land assignments, and investment returns—through secure, self-executing smart contracts.
                  </p>
               </div>
            </div>
         </div>
