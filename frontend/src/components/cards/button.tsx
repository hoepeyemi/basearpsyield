...
const CustomButton = ({ btn, handleClick, className, disabled }: { btn?: string, handleClick?: Function, className?: string, disabled?: boolean }) => {
   ...
   return (
      <>
         <button className={`btn w-full bg-green-900/90 border-0 hover:bg-green-900 mt-4 text-white disabled:bg-green-900/80 disabled:text-white ${className}`} onClick={click} disabled={disabled || loading}>
