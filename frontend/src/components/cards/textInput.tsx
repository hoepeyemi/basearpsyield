...
const TextInput = ({ label, tr, br, bl, placeholder, setValue}: {label: string, tr?: string, br?: string, bl?: string, placeholder?: string, setValue: Function}) => {
  ...
  return (
   ...
   <input type="text" placeholder={placeholder} className="input input-bordered w-full max-w-full placeholder:text-[12px] text-sm bg-white grow focus-within:border-green-300 focus-within:outline-none mb-2" onChange={handleChange}/>
   {/* <div className="label">
