        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-sm">
                BasearpsYield - your reliable partner in creating the perfect
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center">
                  ...
                  <span>+234 (908) 578-3423</span>
                </li>
                <li className="flex items-center">
                  <Mail className="h-4 w-4 mr-2" />
                  <span>afolabiifeoluwa89@gmail.com</span>
                </li>
                <li className="flex items-center">
          ...
          <div className="mt-8 pt-4 border-t border-green-700 text-center text-sm">
            © 2024 BasearpsYield. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
